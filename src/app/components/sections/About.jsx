        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <p className="text-gray-600">
              SpidySofts is a forward-thinking software development company dedicated to creating innovative digital solutions that help businesses succeed in today's competitive landscape.
            </p>
            <p className="text-gray-600">
              Founded in 2018, we've grown from a small team of passionate developers to a full-service software house with expertise across multiple domains and technologies.
            </p>
